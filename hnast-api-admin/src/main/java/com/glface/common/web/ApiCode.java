...
public enum ApiCode {
    ...
    ACCOUNT_EDIT_PASSWORD("","当前密码为弱口令，请修改密码！密码需要包含大写字母、小写字母、特殊符号、不连续数字！"),
	...
	ACCOUNT_USER_PASSWORD_FORMAT("","密码由大写字母、小写字母、特殊符号、不连续数字组成!"),
	...
	PERMISSION_USER_PASSWORD_FORMAT("","密码由大写字母、小写字母、特殊符号、不连续数字组成!"),
