...
<div class="wrap">
	...
	<div class="cont_info" >
		...
		<p >
			<em class="w4 ">项目类型：</em><span class="underline w520 emi" ><i>1.科技与社会发展项目
			<#if project.planType??><#if project.planType.name??>
			<#if project.planType.name == "科技与社会发展项目">
			<img src="/static/select.png" class="ysbzimg">
			<#else>
			<img src="/static/noselect.png" class="ysbzimg">
			</#if></#if></#if>
		...
		<p >
			<em class="w4 "></em><span class="underline w520 emi" ><i>2.公众科学素质建设项目
			<#if project.planType??><#if project.planType.name??>
			<#if project.planType.name == "公众科学素质建设项目">
			<img src="/static/select.png" class="ysbzimg">
			<#else>
			<img src="/static/noselect.png" class="ysbzimg">
			</#if></#if></#if>
		...
		<p >
			<em class="w4 "></em><span class="underline w520 emi" ><i>3.学术交流与决策咨询项目
			<#if project.planType??><#if project.planType.name??>
			<#if project.planType.name == "学术交流与决策咨询项目">
			<img src="/static/select.png" class="ysbzimg">
			<#else>
			<img src="/static/noselect.png" class="ysbzimg">
			</#if></#if></#if>
		...
		<p >
			<em class="w4 "></em><span class="underline w520 emi" ><i>4.大众传播及资源开发与共享项目
			<#if project.planType??><#if project.planType.name??>
			<#if project.planType.name == "大众传播及资源开发与共享项目">
			<img src="/static/select.png" class="ysbzimg">
			<#else>
			<img src="/static/noselect.png" class="ysbzimg">
			</#if></#if></#if>
		...
		<p >
			<em class="w4 "></em><span class="underline w520 emi" ><i>5.国际交流与合作项目
			<#if project.planType??><#if project.planType.name??>
			<#if project.planType.name == "国际交流与合作项目">
			<img src="/static/select.png" class="ysbzimg">
			<#else>
			<img src="/static/noselect.png" class="ysbzimg">
			</#if></#if></#if>
		...
		<p >
			<em class="w4 "></em><span class="underline w520 emi" ><i>6.综合类项目
			<#if project.planType??><#if project.planType.name??>
				<#if project.planType.name == "综合类项目">
					<img src="/static/select.png" class="ysbzimg">
			<#else>
					<img src="/static/noselect.png" class="ysbzimg">
				</#if></#if></#if>
